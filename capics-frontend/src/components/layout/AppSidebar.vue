<template>
  <aside class="sidebar">
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item">
        <router-link to="/mrp" class="nav-link" :class="{ active: $route.path === '/mrp' }">
          MRP计划
        </router-link>
      </li>
      <li class="nav-item">
        <router-link to="/routing" class="nav-link" :class="{ active: $route.path === '/routing' }">
          工艺路线
        </router-link>
      </li>
      <li class="nav-section">生产线</li>
      <li class="nav-item">
        <router-link to="/lines" class="nav-link" :class="{ active: $route.path === '/lines' }">
          生产线配置
        </router-link>
      </li>
      <li class="nav-item">
        <router-link to="/product-line" class="nav-link" :class="{ active: $route.path === '/product-line' }">
          产线一览
        </router-link>
      </li>
