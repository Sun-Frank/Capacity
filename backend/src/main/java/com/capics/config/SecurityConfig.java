    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeRequests()
                ...
                .antMatchers("/api/notebook/**").hasAnyRole("PLAN", "MASTERDATA", "ADMIN")
                .antMatchers("/api/fusion/meeting-minutes/**").hasAnyRole("PLAN", "MASTERDATA", "ADMIN")
                .antMatchers("/api/products/**").hasAnyRole("MASTERDATA", "ADMIN")
                .antMatchers("/api/project-master/**").hasAnyRole("MASTERDATA", "ADMIN")
