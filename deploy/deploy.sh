...
WMS_BOM_PYTHON="${WMS_BOM_PYTHON:-python3}"
WMS_BOM_TIMEOUT_MINUTES="${WMS_BOM_TIMEOUT_MINUTES:-45}"
WMS_CHROMEDRIVER="${WMS_CHROMEDRIVER:-chromedriver}"
...
WMS_BOM_PYTHON=${WMS_BOM_PYTHON}
WMS_BOM_TIMEOUT_MINUTES=${WMS_BOM_TIMEOUT_MINUTES}
WMS_CHROMEDRIVER=${WMS_CHROMEDRIVER}
EOF
